package sunny.basemodel.refresh;
...
public class EndlessRecyclerOnScrollListener extends RecyclerView.OnScrollListener implements OnListLoadNextPageListener {
    ...
    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
        ...
        /*Log.i("wyy", "onScrollStateChanged: visibleItemCount = " + visibleItemCount + ", currentScrollState = " + currentScrollState
                + ", lastVisibleItemPosition = " + lastVisibleItemPosition + ", totalItemCount = " + totalItemCount);*/
        if ((visibleItemCount > 0 && currentScrollState == RecyclerView.SCROLL_STATE_IDLE && (lastVisibleItemPosition) >= totalItemCount - 2 )) {  ///减一有时不对
